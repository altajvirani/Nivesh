 ...
 * Use the {@link FounderUserDOB#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FounderUserDOB extends Fragment {
    ...
    public static FounderUserDOB newInstance(String param1, String param2) {
        FounderUserDOB fragment = new FounderUserDOB();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_founder_user_dob, container, false);
        ...
        StartDateNxtBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    FounderUserGender obj = new FounderUserGender();
                    Bundle args = new Bundle();
