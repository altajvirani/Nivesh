...
public class RevenueFragment extends Fragment {
    ...
    EditText RevenueEditText;
    Button RevenueNxtBtn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RevenueEditText =(EditText) view.findViewById(R.id.revenue_edt_xml);
        RevenueNxtBtn = (Button)view.findViewById(R.id.revenue_next_btn);
        ...
        RevenueNxtBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String TotalRevenue = RevenueEditText.getText().toString();
                ...
                {
                    NoOfEmpFragment obj = new NoOfEmpFragment();
                    Bundle args = new Bundle();
