 ...
 * Use the {@link FounderUserProfileImage#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FounderUserProfileImage extends Fragment {
    ...
    public FounderUserProfileImage() {
    ...
    public static FounderUserProfileImage newInstance(String param1, String param2) {
        FounderUserProfileImage fragment = new FounderUserProfileImage();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_founder_user_profile_image, container, false);
        ...
        ProfileImageNxtBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FounderAboutMe obj = new FounderAboutMe();
                Bundle args = new Bundle();
