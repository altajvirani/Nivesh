 ...
 * Use the {@link NoOfInvestorFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NoOfInvestorFragment extends Fragment {

    EditText TotalInvestorsEditText;
    Button TotalInvestorsNxtBtn;
     ...
     * @return A new instance of fragment NoOfInvestorFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static NoOfInvestorFragment newInstance(String param1, String param2) {
        NoOfInvestorFragment fragment = new NoOfInvestorFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_no_of_investor, container, false);
        TotalInvestorsEditText =(EditText) view.findViewById(R.id.total_investor_edt_xml);
        TotalInvestorsNxtBtn = (Button)view.findViewById(R.id.total_investor_next_btn);
        ...
        TotalInvestorsNxtBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String TotalInvestors = TotalInvestorsEditText.getText().toString();

                if(TextUtils.isEmpty(TotalInvestors))
                {
                    Toast.makeText(getContext(), "This Field be Can't Empty", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    ProblemFragment obj = new ProblemFragment();
                    Bundle args = new Bundle();
