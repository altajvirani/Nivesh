...
import com.phtlearning.nivesh.Founder.Fragments.Profile.FounderOTPVerification;
 ...
 * Use the {@link InvestorContactNumber#newInstance} factory method to
 * create an instance of this fragment.
 */
public class InvestorContactNumber extends Fragment {
     ...
     * @return A new instance of fragment InvestorContactNumber.
     */
    // TODO: Rename and change types and number of parameters
    public static InvestorContactNumber newInstance(String param1, String param2) {
        InvestorContactNumber fragment = new InvestorContactNumber();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_investor_contact_number, container, false);
        ...
        ContactEditText =(EditText) view.findViewById(R.id.investor_contact_edt_xml);
        ContactNxtBtn = (Button)view.findViewById(R.id.investor_contact_next_btn);
                        ...
                        PhoneAuthProvider.getInstance().verifyPhoneNumber("+91"+ContactNumber, 1, TimeUnit.SECONDS, getActivity(),
                                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                                    ...
                                    public void onCodeSent(@NonNull String otp, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                        ...
                                        progressDialog.hide();
                                        InvestorOTPVerification obj = new InvestorOTPVerification();
                                        Bundle args = new Bundle();
